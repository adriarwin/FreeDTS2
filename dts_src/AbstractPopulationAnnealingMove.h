#if !defined(AFX_PopulationAnnealingMove_H)
#define AFX_PopulationAnnealingMove_H
#include <iostream>
/**
...
class AbstractPopulationAnnealingMove {
public:
    /*
     * @brief Default constructor initializes the change rate (DR).
     */
    AbstractPopulationAnnealingMove() {

    }
    /*
     * @brief Virtual destructor.
     */
    virtual ~AbstractPopulationAnnealingMove() {}
    ...
    inline static std::string GetBaseDefaultReadName() { return "Population_Annealing_Move"; }
               ///< Change rate.
};


class NoPopulationAnnealingMove : public AbstractPopulationAnnealingMove {
public:
    NoPopulationAnnealingMove(){
