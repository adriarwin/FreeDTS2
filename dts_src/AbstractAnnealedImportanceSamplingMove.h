#if !defined(AFX_AnnealedImportanceSamplingMove_H)
#define AFX_AnnealedImportanceSamplingMove_H
#include <iostream>
/**
...
class AbstractAnnealedImportanceSamplingMove {
public:
    /*
     * @brief Default constructor initializes the change rate (DR).
     */
    AbstractAnnealedImportanceSamplingMove() {

    }
    /*
     * @brief Virtual destructor.
     */
    virtual ~AbstractAnnealedImportanceSamplingMove() {}
    ...
    virtual bool AnnealedImportanceSamplingMoveOn()=0;
    ...
    inline static std::string GetBaseDefaultReadName() { return "Annealed_Importance_Move"; }
               ///< Change rate.
};


class NoAnnealedImportanceSamplingMove : public AbstractAnnealedImportanceSamplingMove {
public:
    NoAnnealedImportanceSamplingMove(){
