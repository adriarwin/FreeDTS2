#if !defined(AFX_EdgeVertexMCMove_H_8P4B21B8_C13C_5648_BF23_914095086215__INCLUDED_)
#define AFX_EdgeVertexMCMove_H_8P4B21B8_C13C_5648_BF23_914095086215__INCLUDED_
...
class State;
class EdgeVertexMCMove
{
public:
    EdgeVertexMCMove();
    EdgeVertexMCMove(State *pState);
    ~EdgeVertexMCMove();
...
double Length2WithAVertex(Vec3D v, vertex*);
